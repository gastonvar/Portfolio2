                    ...
                    <div className="accordion-body row justify-content-center">
                      <p className="col-12 accordion-caption text-center" id="accordion-caption">
                        ...
                        <p className="text-center">HTML, CSS, JS, REACT y librerías REACT</p>
                          <a target="_blank" rel="noopener noreferrer"className="curriculumButton rounded text-decoration-none" href="https://github.com/gastonvar/Portfolio/tree/master/OBLREACT">GitHub</a>
                        </article>
                        <article className="col-10 col-md-5 mb-3">
                        <figure>
                        ...
                        <p>Portfolio realizado con js, css y html "pelados"</p>
                        <p className="text-center">HTML, CSS, JS</p>
                          <a target="_blank" rel="noopener noreferrer"className="curriculumButton rounded text-decoration-none" href="https://github.com/gastonvar/PortfolioWebDeploy">GitHub</a>
                        </article>
                        <article className="col-10 col-md-5 mb-3">
                        <figure>
                        ...
                        <p className="text-center">C#</p>
                          <a target="_blank" rel="noopener noreferrer"className="curriculumButton rounded text-decoration-none" href="https://github.com/gastonvar/VortexMacro/tree/main/AutoClicker">GitHub</a>
                        </article>
                      <article className="col-10 col-md-5 mb-3">
                        <figure>
                        ...
                        <p>API REST desarrollada en C# .NET y EF para control de stock, MVC que consume los endpoints de la API</p>
                        <p className="text-center">C#, .NET, Razor, EF, Swagger, MVC, Html, Css, SQL</p>
                          <a target="_blank" rel="noopener noreferrer"className="curriculumButton rounded text-decoration-none" href="https://github.com/gastonvar/Portfolio/tree/master/Prog/ObligatorioP3">GitHub</a>
                        </article>
                      <article className="col-10 col-md-5 mb-3">
                        <figure>
                        ...
                        <a target="_blank" rel="noopener noreferrer"className="curriculumButton rounded text-decoration-none" href="https://github.com/gastonvar/Portfolio/tree/master/Prog/Censo_2023">GitHub</a>
                      </article>
                      <article className="col-10 col-md-5 mb-3">
                        <figure>
                          <a target="_blank" rel="noopener noreferrer" href="https://gv316838someeobl.somee.com/">
                        ...
                        <p className="text-center">HTML, CSS, C#, .NET, Razor</p>
                          <a target="_blank" rel="noopener noreferrer"className="curriculumButton rounded text-decoration-none" href="https://github.com/gastonvar/Portfolio/tree/master/Prog/Social.NETWORK">GitHub</a>
                        </article>
                    </div>
                  </div>
                </div>
                  ...
                  <div id="collapseTwo" className="accordion-collapse collapse" data-bs-parent="#accordionExample">
                    <div className="accordion-body row justify-content-center">
                      ...
                      <article className="col-10 col-md-6 mb-4">
                        ...
                        <a target="_blank" rel="noopener noreferrer"href="https://github.com/gastonvar/Portfolio/tree/master/DW/Baldur'sGate" className="curriculumButton rounded text-decoration-none">Github</a>
                      </article>
                      <article className="col-10 col-md-6 mb-4">
                        <figure>
                          <a target="_blank" rel="noopener noreferrer" href="" onclick="return false;">
                        ...
                        <a target="_blank" rel="noopener noreferrer"className="curriculumButton rounded text-decoration-none text-center" href="https://github.com/gastonvar/Portfolio/tree/master/DW/DominosPizza">Github</a>
                      </article>
                      <article className="col-10 col-md-6 mb-4">
                        <figure>
                          <a target="_blank" rel="noopener noreferrer" href="" onclick="return false;">
                        ...
                        <a target="_blank" rel="noopener noreferrer"className="curriculumButton rounded text-decoration-none text-center" href="https://github.com/gastonvar/Portfolio/tree/master/DW/Muebles2">Github</a>
                      </article>
                      <article className="col-10 col-md-6 mb-4">
                        <figure>
                          <a target="_blank" rel="noopener noreferrer" href="" onclick="return false;">
                        ...
                        <a target="_blank" rel="noopener noreferrer"className="curriculumButton rounded text-decoration-none text-center" href="https://github.com/gastonvar/Portfolio/tree/master/DW/Navidad">Github</a>
                      </article>
                      <article className="col-10 col-md-6 mb-4">
                        <figure>
                          <a target="_blank" rel="noopener noreferrer" href="" onclick="return false;">
                        ...
                        <a target="_blank" rel="noopener noreferrer"className="curriculumButton rounded text-decoration-none text-center" href="https://github.com/gastonvar/Portfolio/tree/master/DW/Paris">Github</a>
                      </article>
                      <article className="col-10 col-md-6 mb-4">
                        <figure>
                          <a target="_blank" rel="noopener noreferrer" href="" onclick="return false;">
                        ...
                        <a target="_blank" rel="noopener noreferrer"className="curriculumButton rounded text-decoration-none text-center" href="https://github.com/gastonvar/Portfolio/tree/master/DW/Pull%26Bear">Github</a>
                      </article>
                      <article className="col-10 col-md-6 mb-4">
                        <figure>
                          <a target="_blank" rel="noopener noreferrer" href="" onclick="return false;">
                        ...
                        <a target="_blank" rel="noopener noreferrer"className="curriculumButton rounded text-decoration-none text-center" href="https://github.com/gastonvar/Portfolio/tree/master/DW/Wimbledon">Github</a>
                      </article>
                    </div>
                  </div>
                </div>
                  ...
                  <div id="collapseThree" className="accordion-collapse collapse" data-bs-parent="#accordionExample">
                    <div className="accordion-body row justify-content-center">
                      ...
                      <article className="col-6 mb-4">
                        ...
                        <a target="_blank" rel="noopener noreferrer"className="curriculumButton rounded text-decoration-none text-center" href="https://github.com/gastonvar/Portfolio/tree/master/BD/BDPS2023">Github</a>
                      </article>
                      <article className="col-6 mb-4">
                        <figure>
                          <a target="_blank" rel="noopener noreferrer" href="" onclick="return false;">
                        ...
                        <a target="_blank" rel="noopener noreferrer"className="curriculumButton rounded text-decoration-none text-center" href="https://github.com/gastonvar/Portfolio/tree/master/BD/ObligatorioBD2">Github</a>
                      </article>
                    </div>
                  </div>
                </div>
